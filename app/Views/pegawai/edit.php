    ...
    <div class="pt-3">
        <form action="/pegawai/update/<?= $pegawai->id; ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="alamat" name="alamat" rows="2" required><?= esc($pegawai->alamat); ?></textarea>
            </div>
            <div class="mb-3">
                <label for="telepon" class="form-label">Telepon</label>
                <input type="text" class="form-control" id="telepon" name="telepon" value="<?= esc($pegawai->telepon); ?>" required>
            </div>
            <div class="mb-3">
